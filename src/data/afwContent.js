    ...
    experiences: [
      {
        ...
        description: "Throughout the day, our space offers thoughtfully curated ambient soundscapes perfect for conversation, work, or quiet reflection. Quality sound becomes a subtle enhancement to daily island life."
      },
      {
      ...
      },
      {
        ...
        description: "As night falls, the space evolves into a sophisticated listening environment. Guest selectors and renowned DJs guide sonic journeys that balance deep listening with movement. This isn't loud, generic nightlife—it's an immersive, quality-focused musical experience featuring high-fidelity sound and carefully curated sets."
      },
      {
        title: "Deep Listening Sessions | Sundays, 3:00-5:00 PM",
        description: "Dedicated sessions where complete albums are experienced without interruption. In our age of shuffled playlists and fragmented attention, rediscover the meditative power of hearing a musical work in its entirety, surrounded by fellow listeners in shared contemplation."
      }
    ]
  },
                ...
                sessions: [
                  {
                    time: "4:00-5:00 PM",
                    host: "Meredith Bates",
                    description: "A curated selection of original compositions, improvisations, and music from two decades of band collaborations, woven together with influential works."
                  },
                  {
                    time: "5:30-6:30 PM",
                    host: "Sophia Danai",
                ...
                sessions: [
                  {
                    ...
                    ticketLink: "https://www.eventbrite.ca/e/a-friendly-wave-presents-dark-mode-tickets-1359709270029?aff=ebdsshcopyurl&utm-campaign=social&utm-content=attendeeshare&utm-medium=discovery&utm-term=organizer-profile&utm-share-source=organizer-profile"
                  }
                ]
              }
            ]
                ...
                sessions: [
                  {
                    ...
                    description: "Music that takes you somewhere, with a number of stops being in Africa."
                  },
                  {
                    time: "5:30-6:30 PM",
                    host: "Rave Coach",
                    description: "\"90s-inspired house music — a genre that sparked my passion for DJing.\""
                  }
                ]
              },
              {
                ...
                sessions: [
                  {
                    time: "4:00-5:00 PM",
                    host: "Connie Kuhns",
                    description: "May the Bridges I Burn Light the Way: a subjective selection of women artists from RubymusicRadio who burned bright."
                  },
                  {
                    time: "5:30-6:30 PM",
                    host: "David Wisdom",
                    description: "Music For Art Galleries -1,000 Recordings In Alphabetical Order (For Enhanced Viewing) (Excerpt)"
                  }
                ]
              },
              {
                ...
                sessions: [
                  {
                    time: "4:00-5:00 PM",
                    host: "Matt Robertson",
                    description: "A selection of music that has been inspirational, and loosely demonstrates how changing technology has shaped the creation of music and production."
                  },
                  {
                    time: "5:30-6:30 PM",
                    host: "Chris Arnett",
                    description: "\" I'LL BE PLAYING THE GREATEST HITS YOU NEVER HEARD OF ... \""
                  }
                ]
              },
              {
